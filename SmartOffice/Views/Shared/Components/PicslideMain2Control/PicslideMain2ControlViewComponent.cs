...
namespace SmartOffice.Views.Components.PicslideMain2Control
{
    public class PicslideMain2ControlViewComponent : ViewComponent
    {
       
        private readonly ESmartOfficeContext _dbContext;

        public PicslideMain2ControlViewComponent(ESmartOfficeContext dbContext) {
